...
## TABELA UPLOADS DE EXAMES OU DOCUMENTOS

DROP TABLE IF EXISTS AGENDA_UPLOADS;

CREATE TABLE AGENDA_UPLOADS(
  ID_UPLOAD BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  URL VARCHAR(250) NULL,
  DATE_UPLOAD TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
ALTER TABLE AGENDA_UPLOADS ADD FOREIGN KEY (AGENDA_ID) REFERENCES AGENDAS(ID_AGENDA) ON DELETE CASCADE;
